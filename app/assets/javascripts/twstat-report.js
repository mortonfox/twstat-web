...
function draw_by_month(month_data, month_min, month_max) {
  ...
  new google.visualization.ColumnChart(document.getElementById('by_month')).draw(
    data,
    {
...
function draw_by_dow(dow_data, chart_title, elemid) {
  ...
  // Create and draw the visualization.
  new google.visualization.ColumnChart(document.getElementById(elemid)).draw(
    data,
    {
      title : chart_title,
      width : 600,
...
function draw_by_mention(mention_data, chart_title, elemid) {
  ...
  // Create and draw the visualization.
  new google.visualization.BarChart(document.getElementById(elemid)).draw(
    data,
    {
      title : chart_title,
      width : 600,
